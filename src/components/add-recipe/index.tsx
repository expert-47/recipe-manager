...
import { CREATE_RECIPE } from "@/graphql/mutation/uploadRecipe";
...
const AddRecipeComponent = (props: any) => {
  ...
  const onSubmit = async (data: any, e: any) => {
    ...
    const mutationPromises = data?.ingredients?.map(async (ingredient: any) => {
    ...
    const multiFileUpload = await uploadFileClient.mutate({
    ...
    const createResipeResponse = await createRecipeMutation({
      variables: {
        data: {
                      ...
                      render={({ field, fieldState }) => (
                        <div>
                          <TextField
                            ...
                            variant="outlined"
                            fullWidth
                            value={field[index]?.i_name?.value}
                            onChange={(e) =>
